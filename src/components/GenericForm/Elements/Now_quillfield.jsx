...
const Now_quildfield = (input_props) => {
  ...
  return (
    <div 
      style={{
        ...
        minWidth: "169px", display: current.visible === false ? "none": "",
        marginBottom: "1.4rem"
      }} 
      ...
      <ReactQuill 
        theme="snow" 
        value={current_value}
        style={{height: current.options[0] ? current.options[0] : 369}} 
        onChange={(value_prop) => {
